...
namespace DotJson.Core.Builder
{
	public sealed class DotJsonMiniBuilder : LiteJsonBuilder
	{
		// Default value.
		...
		public async Task BuildAsync(TextWriter writer, object obj)
		{
			if( (obj == null) || (obj is bool) || (obj is char) || (Number.IsNumber(obj)) || (obj is String)) {
				throw new DotJsonMiniException("Top level element should be an object or an array/list.");
			}
			object jsonObj = null;
            ...
            if (GenericUtil.IsDictionary(obj) || GenericUtil.IsList(obj) || obj.GetType().IsArray || obj is Collection<Object>) {
				...
				//    then he/she needs to call DotJsonMiniStructureBuilder.BuildJsonStructure(obj/[]/{}, depth) explicitly
				//    before calling DotJsonMiniBuilder.buildJson().
				LiteJsonStructureBuilder structureBuilder = new DotJsonMiniStructureBuilder();
